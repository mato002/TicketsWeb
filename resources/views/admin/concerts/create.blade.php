                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('venue_address') is-invalid @enderror" 
                                  id="venue_address" name="venue_address" rows="2" required>{{ old('venue_address') }}</textarea>
                        @error('venue_address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('total_tickets') is-invalid @enderror" 
                                       id="total_tickets" name="total_tickets" value="{{ old('total_tickets') }}" 
                                       min="1" required>
                                @error('total_tickets')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="ticket-category row mb-2">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="ticket_categories[0][name]" 
                                           placeholder="Category name (e.g., VIP, Regular)" value="{{ old('ticket_categories.0.name') }}">
                                </div>
                                <div class="col-md-3">
                                    <input type="number" class="form-control" name="ticket_categories[0][price]" 
                                           placeholder="Price" step="0.01" min="0" value="{{ old('ticket_categories.0.price') }}">
                                </div>
                                <div class="col-md-3">
                                    <input type="number" class="form-control" name="ticket_categories[0][quantity]" 
                                           placeholder="Quantity" min="0" value="{{ old('ticket_categories.0.quantity') }}">
                                </div>
                                <div class="col-md-2">
...
// Set available tickets to total tickets by default
document.getElementById('total_tickets').addEventListener('input', function() {
    ...
    if (!availableInput.value || availableInput.value > this.value) {
