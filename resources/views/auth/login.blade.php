...
@section('title', 'Login - TwendeeTickets')
@section('description', 'Sign in to your TwendeeTickets account to manage your event bookings and access exclusive features.')

@section('content')
<!-- Include Popup Banner Components -->
@include('components.popup-banner')
@include('components.scroll-popup')
<div class="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style="background-image: url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=60'); background-size: cover; background-position: center;">
    <div class="bg-black bg-opacity-50 backdrop-blur-sm">
        <div class="max-w-md w-full space-y-8 py-12">
            <div class="bg-white bg-opacity-95 backdrop-blur-lg rounded-2xl shadow-2xl p-8">
                ...
                <p class="mt-2 text-gray-600">Sign in to your TwendeeTickets account</p>
            </div>
