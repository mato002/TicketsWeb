...
<div class="bg-gray-50 min-h-screen">
    <!-- Hero Section -->
    <section class="hero-section relative text-white py-16" style="background-image: url('https://images.pexels.com/photos/3861969/pexels-photo-3861969.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop');">
        <!-- Dark Overlay -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <form class="space-y-6" action="{{ route('public.help.submit-contact') }}" method="POST">
                        @csrf
